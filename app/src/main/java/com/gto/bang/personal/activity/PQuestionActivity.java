...
public class PQuestionActivity extends BaseActivity {
    ...
    public  class ResponseListener implements Response.Listener<Map<String, Object>>, Response.ErrorListener {
        ...
        public void onErrorResponse(VolleyError arg0) {
            t = Toast.makeText(PQuestionActivity.this, Constant.REQUEST_ERROR, Toast.LENGTH_SHORT);
            t.show();
        }
            ...
            if(null==res.get(Constant.STATUS)||!Constant.RES_SUCCESS.equals(res.get(Constant.STATUS).toString())){
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent intent = new Intent(PQuestionActivity.this, EMainActivity.class);
    ...
    public void onResume() {
        super.onResume();
        initData();
        MobclickAgent.onPageStart("我的－问答");
        MobclickAgent.onResume(this);
    }
    @Override
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("我的－问答");
