...
public class CDetailFragment extends Fragment {
    ...
    public CDetailFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.bang_complaint_detail, container, false);
        return rootView;
    }
    ...
    public  class ResponseListener implements Response.Listener<Map<String, Object>>, Response.ErrorListener {
        ...
        public void onResponse(Map<String, Object> res) {
            ...
            if(null==res.get("status")||!Constant.RES_SUCCESS.equals(res.get("status").toString())){
                ...
                TextView content=(TextView)getView().findViewById(R.id.bang_ccontent_tv);
                TextView author=(TextView)getView().findViewById(R.id.bang_cauthor_tv);
                TextView date=(TextView)getView().findViewById(R.id.bang_cdate_tv);
    ...
    protected String getRequestTag(){
        return "ARTICLE_CDetailFragment_REQUEST";
    }
    ...
    public void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("详情－吐槽"); //统计页面
    }
    @Override
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("详情－吐槽");
    }
